...
mt7996_eeprom_check_or_use_default(struct mt7996_dev *dev, bool use_default)
{
	...
	eeprom[MT_EE_TX0_POWER_6G+5] = fw->data[MT_EE_TX0_POWER_6G+5];
	eeprom[MT_EE_TX0_POWER_6G+6] = fw->data[MT_EE_TX0_POWER_6G+6];
	eeprom[MT_EE_TX0_POWER_6G+7] = fw->data[MT_EE_TX0_POWER_6G+7];
